...
c.fonts.completion.category = 'default_size Josevka'
c.fonts.completion.entry = 'default_size Josevka'
c.fonts.contextmenu = 'default_size Josevka'
c.fonts.debug_console = 'default_size Josevka'
c.fonts.default_family = ['Fira Sans Condensed']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Josevka'
c.fonts.hints = 'default_size Josevka'
c.fonts.keyhint = 'default_size Josevka'
c.fonts.messages.error = 'default_size Josevka'
c.fonts.messages.info = 'default_size Josevka'
c.fonts.messages.warning = 'default_size Josevka'
c.fonts.prompts = 'default_size Josevka'
c.fonts.statusbar = 'default_size Josevka'
c.fonts.tabs.selected = 'default_size Josevka'
c.fonts.tabs.unselected = 'default_size Josevka'
c.fonts.web.family.fixed = 'Josevka'
