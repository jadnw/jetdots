...
c.fonts.completion.category = 'default_size Iosevka Jaden'
c.fonts.completion.entry = 'default_size Iosevka Jaden'
c.fonts.contextmenu = 'default_size Iosevka Jaden'
c.fonts.debug_console = 'default_size Iosevka Jaden'
c.fonts.default_family = ['Barlow']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Iosevka Jaden'
c.fonts.hints = 'default_size Iosevka Jaden'
c.fonts.keyhint = 'default_size Iosevka Jaden'
c.fonts.messages.error = 'default_size Iosevka Jaden'
c.fonts.messages.info = 'default_size Iosevka Jaden'
c.fonts.messages.warning = 'default_size Iosevka Jaden'
c.fonts.prompts = 'default_size Iosevka Jaden'
c.fonts.statusbar = 'default_size Iosevka Jaden'
c.fonts.tabs.selected = 'default_size Iosevka Jaden'
c.fonts.tabs.unselected = 'default_size Iosevka Jaden'
c.fonts.web.family.fixed = 'Iosevka Jaden'
