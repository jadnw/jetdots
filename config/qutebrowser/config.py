...
c.fonts.completion.category = 'default_size Josevka Curly'
c.fonts.completion.entry = 'default_size Josevka Curly'
c.fonts.contextmenu = 'default_size Josevka Curly'
c.fonts.debug_console = 'default_size Josevka Curly'
c.fonts.default_family = ['Assistant']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Josevka Curly'
c.fonts.hints = 'default_size Josevka Curly'
c.fonts.keyhint = 'default_size Josevka Curly'
c.fonts.messages.error = 'default_size Josevka Curly'
c.fonts.messages.info = 'default_size Josevka Curly'
c.fonts.messages.warning = 'default_size Josevka Curly'
c.fonts.prompts = 'default_size Josevka Curly'
c.fonts.statusbar = 'default_size Josevka Curly'
c.fonts.tabs.selected = 'default_size Josevka Curly'
c.fonts.tabs.unselected = 'default_size Josevka Curly'
c.fonts.web.family.fixed = 'Josevka Curly'
c.fonts.web.family.sans_serif = 'Assistant'
c.fonts.web.family.serif = 'Noto Serif'
c.fonts.web.family.standard = 'Assistant'
