...
c.colors.tabs.even.fg = colors['gray']
c.colors.tabs.indicator.error = colors['yellow']
c.colors.tabs.indicator.start = colors['fg1']
c.colors.tabs.indicator.stop = colors['fg1']
c.colors.tabs.indicator.system = 'rgb'
c.colors.tabs.odd.bg = colors['bg0']
c.colors.tabs.odd.fg = colors['gray']
...
c.fonts.completion.category = 'default_size Iosevka Custom'
c.fonts.completion.entry = 'default_size Iosevka Custom'
c.fonts.contextmenu = 'default_size Iosevka Custom'
c.fonts.debug_console = 'default_size Iosevka Custom'
c.fonts.default_family = ['Noto Sans Display SemiCondensed']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Iosevka Custom'
c.fonts.hints = 'default_size Iosevka Custom'
c.fonts.keyhint = 'default_size Iosevka Custom'
c.fonts.messages.error = 'default_size Iosevka Custom'
c.fonts.messages.info = 'default_size Iosevka Custom'
c.fonts.messages.warning = 'default_size Iosevka Custom'
c.fonts.prompts = 'default_size Iosevka Custom'
c.fonts.statusbar = 'default_size Iosevka Custom'
c.fonts.tabs.selected = 'default_size Iosevka Custom'
c.fonts.tabs.unselected = 'default_size Iosevka Custom'
c.fonts.web.family.fixed = 'Iosevka Custom'
c.fonts.web.family.sans_serif = 'Noto Sans Display SemiCondensed'
c.fonts.web.family.serif = 'Noto Serif'
c.fonts.web.family.standard = 'Noto Sans Display SemiCondensed'
