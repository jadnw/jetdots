...
c.fonts.completion.category = 'default_size Josevka Jet'
c.fonts.completion.entry = 'default_size Josevka Jet'
c.fonts.contextmenu = 'default_size Josevka Jet'
c.fonts.debug_console = 'default_size Josevka Jet'
c.fonts.default_family = ['Fira Sans Condensed']
c.fonts.default_size = '12pt'
c.fonts.downloads = 'default_size Josevka Jet'
c.fonts.hints = 'default_size Josevka Jet'
c.fonts.keyhint = 'default_size Josevka Jet'
c.fonts.messages.error = 'default_size Josevka Jet'
c.fonts.messages.info = 'default_size Josevka Jet'
c.fonts.messages.warning = 'default_size Josevka Jet'
c.fonts.prompts = 'default_size Josevka Jet'
c.fonts.statusbar = 'default_size Josevka Jet'
c.fonts.tabs.selected = 'default_size Josevka Jet'
c.fonts.tabs.unselected = 'default_size Josevka Jet'
c.fonts.web.family.fixed = 'Josevka Jet'
