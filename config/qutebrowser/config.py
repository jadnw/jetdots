...
c.fonts.completion.category = 'default_size Jetevka'
c.fonts.completion.entry = 'default_size Jetevka'
c.fonts.contextmenu = 'default_size Jetevka'
c.fonts.debug_console = 'default_size Jetevka'
c.fonts.default_family = ['Assistant']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Jetevka'
c.fonts.hints = 'default_size Jetevka'
c.fonts.keyhint = 'default_size Jetevka'
c.fonts.messages.error = 'default_size Jetevka'
c.fonts.messages.info = 'default_size Jetevka'
c.fonts.messages.warning = 'default_size Jetevka'
c.fonts.prompts = 'default_size Jetevka'
c.fonts.statusbar = 'default_size Jetevka'
c.fonts.tabs.selected = 'default_size Jetevka'
c.fonts.tabs.unselected = 'default_size Jetevka'
c.fonts.web.family.fixed = 'Jetevka'
