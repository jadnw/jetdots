...
c.fonts.completion.category = 'default_size Josevka Curve'
c.fonts.completion.entry = 'default_size Josevka Curve'
c.fonts.contextmenu = 'default_size Josevka Curve'
c.fonts.debug_console = 'default_size Josevka Curve'
c.fonts.default_family = ['Fira Sans Condensed']
c.fonts.default_size = '11pt'
c.fonts.downloads = 'default_size Josevka Curve'
c.fonts.hints = 'default_size Josevka Curve'
c.fonts.keyhint = 'default_size Josevka Curve'
c.fonts.messages.error = 'default_size Josevka Curve'
c.fonts.messages.info = 'default_size Josevka Curve'
c.fonts.messages.warning = 'default_size Josevka Curve'
c.fonts.prompts = 'default_size Josevka Curve'
c.fonts.statusbar = 'default_size Josevka Curve'
c.fonts.tabs.selected = 'default_size Josevka Curve'
c.fonts.tabs.unselected = 'default_size Josevka Curve'
c.fonts.web.family.fixed = 'Josevka Curve'
